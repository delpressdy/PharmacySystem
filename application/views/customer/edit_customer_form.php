                  ...
                  <?php echo form_open_multipart('Ccustomer/customer_update',array('class' => 'form-vertical', 'id' => 'customer_update'))?>
                    <div class="panel-body">
                      <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label for="address2" class="col-sm-4 col-form-label"><?php echo display('city'); ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-8">
                                <input class="form-control" name="address2" id="address2" type="text" value="{address2}" placeholder="<?php echo display('address2') ?>"  >
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" name="state" id="state" rows="2" placeholder="<?php echo display('customer_address') ?>2" >{customer_address}</textarea>
                            </div>
                        </div> -->
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" name="zip" id="zip" type="text" value="{zip}" placeholder="Purok/Street/Baranggay">
                            </div>
                        </div> -->
