            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                     ...
                     <div class="col-sm-6">
                       ...
                       <!-- PHONE NUMBER -->
                         <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" name="phone" id="phone" type="phone" placeholder="<?php echo display('phone') ?>"  min="0" tabindex="2" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="mobile" class="col-sm-4 col-form-label"><?php echo display('zip') ?><i class="text-danger">*</i></label>
                            <div class="col-sm-8">
                                <input class="form-control" name ="mobile" id="mobile" type="text" placeholder="<?php echo display('customer_mobile') ?>" min="0" tabindex="3" required>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label for="address " class="col-sm-4 col-form-label"><?php echo display('customer_address') ?><i class="text-danger">*</i></label></label>
                            <div class="col-sm-8">
                                <textarea class="form-control" name="address" id="address " rows="2" placeholder="Purok/Street/Baranggay" required></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="address2 " class="col-sm-4 col-form-label"><?php echo 'City/Municipal';?><i class="text-danger">*</i></label>
                            <div class="col-sm-8">
                                <textarea class="form-control" name="address2" id="address2" rows="2" placeholder="<?php echo display('city') ?>" required></textarea>
                            </div>
                        </div>
                        <!-- CITY -->
                        <!-- <div class="form-group row">
                      ...
                      <!-- <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <!-- <label for="suki" class="col-sm-4 col-form-label"><?php echo 'Advance Payment'; ?></label> -->
                            <div class="col-sm-8">
                                <input class="form-control" name="suki" id="suki" type="hidden" value="suki" tabindex="5">
                            </div>
                        </div>
                    </div>
