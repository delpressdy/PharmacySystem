    ...
    <div class="panel panel-bd">
        <div class="panel-heading">
            <div class="view-header">
                <div class="header-icon">
                    <img src="../my-assets/image/logo/cup.png">
                    <!-- <i class="pe-7s-unlock"></i> -->
                </div>
                <div class="header-title">
                    <h3>SAN CARLOS PHARMACY</h3>
                    <small><strong>San Pedro, Dumingag, Zamboanga Del Sur</strong></small>
                </div>
            </div>
        </div>
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <span class="help-block small"><?php echo "Hint: owner's name"; ?></span>
            </div>
