    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                    ...
                    <a href="<?php echo base_url('Cmanufacturer/manage_manufacturer') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('manage_supplier') ?> </a>
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <label for="manufacturer_name" class="col-sm-4 col-form-label"><?php echo display('supplier_name') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-8">
                                <input class="form-control" name ="manufacturer_name" id="manufacturer_name" type="text" placeholder="<?php echo display('supplier_name') ?>"  required="" tabindex="1">
                            </div>
                        </div>
                       	...
                       	<div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" name="mobile" id="mobile" type="number" placeholder="<?php echo 'Zip Code'; ?>"  min="0" tabindex="2">
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" name="previous_balance" id="previous_balance" type="hidden" min="0" placeholder="<?php echo display('previous_balance') ?>" tabindex="5">
                            </div>
                        </div>
                    </div>
