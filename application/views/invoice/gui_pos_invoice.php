...
<div class="content-wrapper">
    ...
    <div class="alert alert-danger fade in" id="almsg" > No Available Quantity ..
   </div>
      ...
      <div class="tab-pane active" id="nsale">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="input-group">
                        <input type="text" id="product_name" class="form-control search-field" dir="ltr" value="" name="s" placeholder="Search By Product" autofocus>
...
{
echo '<strong style="font-weight: 700; font-size:16px;">'.html_escape($text).'<br><i style="color: red;">'.html_escape($text2.$unit).'</i></strong>';
}
;
                                ?></div>
                            </div>
           ...
           <div class="form-group row guicustomerpanel">
             <div class="col-sm-5">                           
                   <input type="hidden" name="product_name" class="form-control col-sm-2" placeholder='<?php echo display('barcode_qrcode_scan_here') ?>' id="add_item" autocomplete='off' tabindex="1" value="">
            </div>
                ...
                <!-- <label class="col-sm-2">OR</label> -->
                    ...
                    <input type="hidden" name="product_name_m" class="form-control col-sm-2" placeholder='Manual Input barcode' id="add_item_m_g" autocomplete='off' tabindex="1" value="">
            ...
            <div class="form-group">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-10">
                                <br>
                                    ...
                                    ?>
                                    <big id="emailHelp" class="text-danger"><?php echo 'Please add customer before proceeding!'; ?></big>
                                    <?php
                                        }
                                    ?>
                       ...
                       <input type="text" size="100"  name="customer_name" class="customerSelection form-control" placeholder='<?php echo display('customer_name').'/'.display('phone') ?>' id="customer_name" value="{customer_name}" tabindex="3"  onkeypress="customer_autocomplete(1)" required/>
                       <input id="autocomplete_customer_id" class="customer_hidden_value" type="hidden" name="customer_id" value="{customer_id}">
                        ...
                        <input id="date" class="" type="hidden" name="invoice_date" value="<?php echo date('Y-m-d h:i a');?>">
                         
</div>
    
    <!-- REMOVE COMMENT PARA NAAY PLUS BUTTON PARA ADD CUSTOMER SA POS -->
    <div class="col-sm-2">
          ...
          <div class="table-responsive guiproductdata">
                            <table class="table table-bordered table-hover table-sm nowrap gui-products-table" id="normalinvoice">
                                <thead>
                                    <tr>
                                        <th class="text-center gui_productname"><?php echo display('item_information') ?>
                                            <i class="text-danger">*</i>
                                        </th>

                                        <th class="text-center" width="150"><?php echo display('batch')?>

                                        <th class="text-center"><?php echo display('expiry') ?></th>

                                        <th class="text-center"><?php echo display('qty') ?>
                                            <i class="text-danger">*</i>
                                        </th>
                        ...
                        <div class="footer">
                             <div class="form-group row guifooterpanel">
                                     <div class="col-sm-12">
                                        ...
                                        <!-- <label for="date" class="col-sm-5 col-form-label"><?php echo display('invoice_discount') ?>:</label> -->

                                        <div class="col-sm-5">  <input type="hidden" id="invdcount" class="form-control text-right" name="invdcount" onkeyup="calculateSum(),checknum();" onchange="calculateSum()" placeholder="0.00" />
                                            </div></div>
                               ...
                               <div class="col-sm-12"> 
                                <label for="date" class="col-sm-5 col-form-label"><?php echo html_escape($taxfldt['tax_name']) ?>:
                                </label>
                                <div class="col-sm-5">
                            ...
                            <?php $x++;}?>
                                        ...
                                        <div class="form-group row guifooterpanel">
                                              ...
                                              <div class="col-sm-12">
                                                <!-- <label for="date" class="col-sm-5 col-form-label"><?php echo display('total_tax') ?>:
                                                </label> -->
                                                <div class="col-sm-5">
                                                ...
                                                <!-- BUTTON TOGGLE PARA COLLAPSE -->
                                                <!-- <a class="col-sm-2 btn btn-primary taxbutton" href="#" data-toggle="collapse" data-target="#taxdetails" aria-expanded="false" aria-controls="taxdetails"><i class="fa fa-angle-double-up"></i>
                                                </a> -->
                                        </div> 
                                        ...
                                        <div class="form-group row guifooterpanel">
                                         ...
                                         <div class="form-group row guifooterpanel">
                                              <div class="col-sm-12"> 
                                                <!-- <label for="date" class="col-sm-5 col-form-label"><?php echo display('previous'); ?>:
                                                </label> -->
                                                <div class="col-sm-5">  <input type="hidden" id="previous" class="form-control text-right" name="previous" value="0.00" readonly="readonly" /></div></div>
                                 ...
                                 <div class="row">
                                  ...
                                  <div class="col-sm-12">
                                    <label for="net_total" class="col-sm-1 col-form-label"><?php echo display('net_total'); ?>:</label><div class="col-sm-3">  <input type="text" id="n_total" class="form-control text-right guifooterfixedinput" name="n_total" value="0" readonly="readonly" placeholder="" />
                                            ...
                                            <label for="date" class="col-sm-1 col-form-label"><?php echo 'Cash'; ?>:</label><div class="col-sm-3"> <input type="text" id="paidAmount" 
                                               onkeyup="invoice_paidamount();" class="form-control text-right guifooterfixedinput" name="paid_amount" placeholder="0.00" tabindex="13" autocomplete="off" required/></div>                                            
                                        
                                        
                                           <!-- <label for="date" class="col-sm-1 col-form-label"></label> --><div class="col-sm-3">  <input type="hidden" id="dueAmmount" class="form-control text-right guifooterfixedinput" name="due_amount" value="0.00" readonly="readonly" /></div>
