	                            ...
	                            <table class="table table-striped table-bordered">
	                                ...
	                                <tbody>
										...
										<tr>
	                                        ...
	                                        <?php }elseif($discount_type == 2){ ?>
	                                        <td align="center"><?php echo (($position==0)?"₱ ".$discounts."":"".$discounts." ₱");
	                                        ...
	                                        <td align="center"><?php echo (($position==0)?"₱ ".$details['rate']."":"".$details['rate']." $currency") ?></td>
	                                        <td align="right"><?php
	                                         if($details['quantity'] < 0){ 
	                                         ...
	                                         echo (($position==0)?"₱ ".html_escape($totalprice)."":"".html_escape($totalprice)." $currency") ?></td>
	                                    </tr>
	                                <?php }?>
	                                ...
	                                <tfoot>
	                                	...
	                                	<td class="text-right" align="center" ><b><?php echo (($position==0)?"₱ ".html_escape($subtotalamount): html_escape($subtotalamount)." ₱") ?></b></td>
	                                </tfoot>
	                            </table>
	                        </div>
	                        <div class="row">
		                            ...
		                            <div class="col-xs-4">
                                        ...
                                        if ($invoice_all_data[0]['invoice_discount'] != 0) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right"><?php echo (($position == 0) ? "₱ {invoice_discount}" : "{invoice_discount} $currency") ?> </td>
                                            </tr>
                                            <?php
                                        }
