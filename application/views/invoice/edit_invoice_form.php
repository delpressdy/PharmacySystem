                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <center>
                                            ...
                                            <!-- <label class="text-center" for="details" class="  col-form-label"><?php echo display('invoice_details') ?></label> -->
                            ...
                            <?php $x++;}?>
                              <tr>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <input type="hidden" id="full_paid_tab" class="btn btn-warning" value="<?php echo display('full_paid') ?>" tabindex="14" onClick="full_paid()"/>
