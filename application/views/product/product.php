		        ...
		        <div class="panel panel-bd lobidrag">
		            <div class="panel-heading">
		                <div class="panel-title">
		                    ...
		                    <!-- REMOVE COMMENT PARA NAAY OPTION MAKA EXPORT OG CSV SA MEDICINES  -->
		            ...
		            <input type="number" id="total_product"  placeholder="Total Products: <?php echo html_escape($total_product);?>" name="" readonly>
		      </div>
		    </div>
           <?php
           }
