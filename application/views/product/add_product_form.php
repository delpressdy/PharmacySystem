                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('product') ?></h4>
                        </div>
                    </div>
                    ...
                    <div class="panel-body">
                         ...
                         <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" name="product_id" type="text" id="product_id" value="<?php $code= rand(100000, 999999); echo $code; ?>"  tabindex="1" readonly>
                                    </div>
                                </div>
                           ...
                           <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="strength" class="col-sm-4 col-form-label">Strength/Weight<i class="text-danger"></i></label>
                                    <div class="col-sm-8">
                                        <input class="form-control" tabindex="1" name="strength" type="text" id="Input details" placeholder="<?php echo display('strength'); ?>" >
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                                    ...
                                    <!-- <div class="col-sm-8">
                                        <input class="form-control" name="box_size" type="hidden" id="box_size" placeholder="<?php echo display('box_size') ?>" value="<?php $rand = rand(1, 10); ?>" tabindex="3" min="0" required="required">
                                    </div> -->
                           ...
                           <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="product_location" class="col-sm-4 col-form-label"><?php echo 'Date added'; ?></label>
                                    <div class="col-sm-8">
                                        <?php $date = date('Y-m-d'); ?>
                                        <input class="form-control " tabindex="5" name="product_location" type="text" id="product_location" placeholder="<?php echo 'Date added'; ?>" onchange="checkExpiredate(1)" value="<?php echo $date; ?>" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
...
?>
                         ...
                         <div class="row" id="manufacturer_info">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="manufacturer" class="col-sm-4 col-form-label"><?php echo display('supplier') ?> <i class="text-danger">*</i></label>
                                    <div class="col-sm-8">
                                        ...
                                        <a data-target="#manufac_modal" data-toggle="modal"><i class="fa fa-plus"></i><?php echo 'Add new supplier'; ?></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    ...
                                    <label for="manufacturer_price" class="col-sm-4 col-form-label"><?php echo "Supplier's price"; ?> <i class="text-danger">*</i></label>
                                    <div class="col-sm-8">
