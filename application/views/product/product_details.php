		    ...
		    <div class="col-sm-12">
		        <div class="panel panel-bd lobidrag">
		            ...
		            <div class="panel-body">
						...
						<?php echo (($position==0)?"₱ {price}":"{price} ₱") ?></span></h4>
						<table class="table">
							<tr>
		                    ...
		                    <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
								...
								{purchaseData}
									<tr>
										...
										<td  class="text-right"><?php echo (($position==0)?"₱ {rate}":"{rate} $currency") ?></td>
										<td class="text-right"> <?php echo (($position==0)?"₱ {total_amount}":"{total_amount} $currency") ?></td>
									</tr>
								{/purchaseData}
								<?php
									}
								...
								<tfoot>
									<tr>
										...
										<td class="text-right"><b> <?php echo (($position==0)?"₱ {purchaseTotalAmount}":"{purchaseTotalAmount} $currency") ?></b></td>
									</tr>
								</tfoot>
		                    </table>
		                </div>
		                    ...
		                    <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
								...
								{salesData}
									<tr>
										...
										<td  class="text-right">{quantity}</td>
										<td  class="text-right"> <?php echo (($position==0)?"₱ {rate}":"{rate} $currency") ?></td>
										<td class="text-right"> <?php echo (($position==0)?"₱ {total_price}":"{total_price} $currency") ?></td>
									</tr>
								{/salesData}
								<?php
									}
								...
								<tfoot>
									<tr>
										...
										<td  class="text-right"><b> <?php echo (($position==0)?"₱ {salesTotalAmount}":"{salesTotalAmount} $currency") ?></b></td>
									</tr>
								</tfoot>
		                    </table>
		                </div>
