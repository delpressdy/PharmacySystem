                    ...
                    <div class="row">
                            ...
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                         <input class="form-control" required="required" name="generic_name" tabindex="2" type="text" id="generic_name" placeholder="<?php echo display('generic_name') ?>" value="{generic_name}" readonly>
                                    </div>
                                </div> 
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="product_location" class="col-sm-4 col-form-label"><?php echo display('expeire_date') ?></label>
                                    <div class="col-sm-8">
                                        <input class="form-control datepicker" name="product_location" tabindex="4" id="product_location" placeholder="<?php echo display('product_location') ?>" value="{product_location}" readonly >
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="col-sm-6">
                             ...
                             <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" name="strength" type="text" id="strength" tabindex="3" placeholder="<?php echo display('strength'); ?>"  value="{strength} {unit}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" name="description" id="description" tabindex="5" rows="3" readonly>{product_details}</textarea>
                                    </div>
                                </div> 
                            </div>
