...
?>
        ...
        <div class="row">
           ...
           <?php
            ...
            <a href="<?php echo base_url('Ccustomer/manage_customer')?>" class="small-box-footer"><?php echo display('customer')?> </a>
          </div>
               </div>
            <?php } ?>
            ...
            <a href="<?php echo base_url('Cmanufacturer/manage_manufacturer')?>" class="small-box-footer"><?php echo display('Manufacturer')?> </a>
          </div>
                </div>
             <?php } ?>
...
<input type="hidden" id="months" value='<?php 
 ...
 <input type="hidden" name="" id="pie_total_service" value="0">
 <input type="hidden" name="" id="pie_total_expense" value="0"> 
 <input type="hidden" name="" id="pie_total_salary" value="0">   
 <input type="hidden" id="currency" value="<?php echo  html_escape($currency)?>" name="">
        </div>
        <hr>
        <!-- Second Counter -->
       
            <!-- DISPLAY ANG SALES REPORT NGA NAKA TABLE -->
            <!-- /////////////////////////////////////// -->
 ...
 -->                                    <!-- <tr>
            ...
            <!-- <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
               <div class="panel panel-bd lobidisable">
                    ...
                    <div class="panel-body">
                        <canvas id="bestsalechart" height="150"></canvas>
                    </div>
                </div>
            </div> -->
