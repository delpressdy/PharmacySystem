                        ...
                        <div class="row" id="manufacturer_info">
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    <label for="manufacturer_sss" class="col-sm-3 col-form-label"><?php echo display('supplier')?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8"> 
                                        <?php 
                                              ...
                                              $time = date('h:m a');
                                        ?>
                                        <input type="text" tabindex="2" class="form-control datepicker" name="purchase_date" value="<?php echo $date.' at '. $time; ?>" id="purdate" required />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" tabindex="3" class="form-control" name="chalan_no" value="<?php $buyNo=rand(100000,999999); echo $buyNo ?>" id="invoice_no" readonly/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-bordered table-hover" id="purchaseTable">
                                <thead>
                                    <tr>
                                            ...
                                            <th class="text-center"><?php echo "Supplier's rate"; ?><i class="text-danger">*</i></th>
                                ...
                                <tbody id="addPurchaseItem">
                                    <tr>
                                        <td class="span3 manufacturer">
                                         ...
                                         <td>
                                                <input type="text" name="batch_id[]" id="batch_id_1" class="form-control text-right"  tabindex="7" value="<?php $batchID=rand(10000,99999); echo $batchID; ?>" readonly/>
                                            </td>
                                            <td>
                                       ...
                                       <td class="wt">
                                            ...
                                            <td class="text-right">
                                                <input type="text" name="product_quantity[]" id="quantity_1" class="form-control text-right store_cal_1" onkeyup="calculate_store(1),checkqty(1);" onchange="calculate_store(1);" placeholder="0.00" value="" min="0" tabindex="9" required/>
                                            </td>
                                            <td class="test">
                                                <input type="text" name="product_rate[]" onkeyup="calculate_store(1),checkqty(1);" onchange="calculate_store(1);" id="product_rate_1" class="form-control product_rate_1 text-right" placeholder="0.00" value="" min="0" tabindex="10" readonly />
                                            </td>
                                           
                                            <td class="text-right">
                                                <input class="form-control total_price text-right" type="text" name="total_price[]" id="total_price_1" placeholder="0.00" readonly="readonly" />
                                            </td>
                                            <td>
