	                    ...
	                    <div class="panel-body">
	                        <div class="row">
	                            ...
	                            <div class="col-sm-8 purchasedetails-address">
	                                ...
	                                <br>
	                                <span class="label label-success-outline m-r-15 p-10" ><?php echo display('billing_from') ?></span><br><br>
	                                <address class="margin-top10">
	                                    <strong>{company_name}</strong><br>
	                                    {address}<br><br>
	                                    <abbr><b><?php echo display('mobile') ?>:</b></abbr> {mobile}<br><br>
	                                    <abbr><b><?php echo display('email') ?>:</b></abbr>
	                                    {email}<br><br>
	                                    <abbr><b><?php echo display('website') ?>:</b></abbr>
	                                    <a href="localhost/sancarlos">localhost/sancarlos</a>
	                                    <!-- {website} Remove comment except bracketed website to display site -->
	                                    {/company_info}<br>
	                                </address>
	                            </div>

	                            <div class="col-sm-4 text-left invoice-address"><br>
	                                <span class="label label-success-outline m-r-15"><?php echo display('billing_to')?></span>
	                                  <address class="customer_name_p"><br>
	                                    ...
	                                    <br><br>
	                                    <abbr><b><?php echo 'Contact'; ?>:</b></abbr>
	                        ...
	                        <div class="table-responsive m-b-20">
	                            <table class="table table-striped table-bordered">
									...
									$sl = 1;
									 foreach($details as $purdetails){?>
										<tr>
	                                        ...
	                                        <td align="center"><?php echo (($position==0)?'₱'.' '.$purdetails['rate']:$purdetails['rate'].' '. $currency) ?></td>
	                                        <td align="right"><?php
	                                         ...
	                                         echo (($position==0)?'₱'.' '.$t_amount:$t_amount.' '. $currency);
	                                ...
	                                <tfoot>
	                                	...
	                                	<td></td>
	                                	<td class="text-right" align="center" ><b><?php echo (($position==0)?'₱'.' '. $sub_total:$sub_total.' '.$currency) ?></b></td>
	                                </tfoot>
	                            </table>
	                        </div>
	                        <div class="row">
		                        ...
		                        <div class="row paddin5ps">
	                                ...
	                                <div>
	                                	<strong>
	                                		<?php echo display('voucher_no') ?>:
	                                	</strong>
	                                		<?php echo $purchase[0]['chalan_no'];?>
	                                </div>

	                                 <div>
	                                 	<strong>
	                                 		<?php echo display('purchase_id') ?>:
	                                 	</strong>
	                                 		<?php echo $purchase[0]['purchase_id'];?>
	                                 </div>

	                                <div class="m-b-15">
	                                	<strong>
	                                		<?php echo display('billing_date') ?>:
	                                	</strong>
	                                		<?php echo $purchase[0]['purchase_date'];?>
	                                	<br>
	                                	<br>
	                                		Authorized by 
	                                	<strong>
		                        	...
		                        	<div class="col-sm-6"> 
		                        		<!-- to change the location to right ~ change the inv-footer-center to inv-footer-right -->
		                        		<div class="inv-footer-center">
											<!-- <?php echo display('authorised_by') ?><br> -->
											<!-- Authorized by <strong>Oscarina Tare</strong> -->
										</div>	
									</div>
