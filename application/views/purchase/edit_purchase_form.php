                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" tabindex="3" class="form-control" name="chalan_no" placeholder="<?php echo display('invoice_no') ?>" id="invoice_no" readonly  value="{chalan_no}" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <tbody id="addPurchaseItem">
                                    ...
                                    <tr>
                                       ...
                                       <td class="wt">
                                            ...
                                            <td class="test">
                                                <input type="text" name="product_rate[]" onkeyup="calculate_store({sl}),checkqty({sl});" onchange="calculate_store({sl});" id="product_rate_{sl}" class="form-control product_rate_{sl} text-right" placeholder="0.00" value="{rate}" readonly min="0" tabindex="{ratetap}"/>
                                            </td>
