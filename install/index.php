    ...
    <div class="container"> 
        ...
        <div class="row"> 
            <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1"> 
                <header class="header">
                    <h1 class="header-title">Installer</h1>
                </header>
                        ...
                        <div id="wizard" class="aiia-wizard">
                            ...
                            <div class="aiia-wizard-step <?php echo $activeClass ?>">
                                ...
                                <div class="step-content step-one">
                                    <div class="row">
                                        <h3 class="title text-center"><p>Apache runtime status: <strong>READY</strong></p></h3>
                                        <div class="col-sm-8">
                                            <input type="hidden" name="_token" value="<?php echo  (!empty($token)?$token:null) ?>"/>

                                            <div class="form-group">
                                               <!--  <label for="userid" class="col-sm-4 col-form-label">Username<span class="glyphicon glyphicon-question-sign" data-toggle="tooltip" data-placement="bottom" title="Enter Envato User ID or Enter 'bdtask' as non Envato User">
                                                </span> </label> -->
                                                <div class="col-sm-8">
                                                    <input type="hidden" class="form-control" id="userid" name="userid" value="oscarinatare@mail.com" placeholder="User ID" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <!-- <label for="purchase_key" class="col-sm-4 col-form-label">Key <span class="glyphicon glyphicon-question-sign" data-toggle="tooltip" data-placement="bottom" title="Enter Purchase Key which you got by envato purchase or bdtask support.">
                                                </span></label> -->
                                                <div class="col-sm-8">
                                                    <input type="hidden" class="form-control" id="purchase_key" value="oscarinatare@mail.com"  name="purchase_key"  placeholder="Purchase Key" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="aiia-wizard-step <?php echo (isset($_GET['step2'])?'active':'') ?>">
                                ...
                                <div class="step-content step-two">
                                    <div class="app_content">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <h3 class="title text-center"><p>MySQL runtime status: <strong>READY</strong></p></h3>
                            ...
                            <div class="aiia-wizard-step <?php echo (isset($_GET['step3'])?'active':'') ?>">
                                ...
                                <div class="step-content step-three">
                                        <h3 class="title text-center"><p>Database: <strong>sancarlos</strong></p></h3>
                                        <input type="hidden" name="_token" value="<?php echo  (!empty($token)?$token:null) ?>"/>
                                        <div class="form-group">
                                           <!--  <label for="database">Database Name </label> -->
                                            <input type="hidden" name="database" class="form-control" id="database" placeholder="Database Name" value="sancarlos">
                                        </div> 
                                        <div class="form-group">
                                            <!-- <label for="username">Username </label> -->
                                            <input type="hidden" name="username" class="form-control" id="username" placeholder="Username" value="root">
                                        </div> 
                                        <div class="form-group">
                                            <!-- <label for="password">Password </label> -->
                                            <input type="hidden" name="password" class="form-control" id="password" placeholder="Password" value="">
                                        </div>  
                                        <div class="form-group">
                                           <!--  <label for="hostname">Host Name <span class="glyphicon glyphicon-question-sign" data-toggle="tooltip" data-placement="bottom" title="Please keep localhost by default, but if need you can add your own domain name or ip address"></span></label> -->
                                            <input type="hidden" name="hostname" class="form-control" id="hostname" placeholder="Host Name"  value="localhost">
                                        </div> 
                                ...
                                <div class="row" >
                                    <div class="col-sm-7">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="hidden" name="email" class="form-control" id="email" value="oscarinatare@mail.com" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <!-- <label for="pass" class="col-sm-4 col-form-label">Password</label> -->
                                            <div class="col-sm-8">
                                                <input type="hidden" name="password" class="form-control" value="oscarina" id="pass" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="step-content step-five">
                                    ...
                                    <div class="col-sm-12">
                                        <?php
                                                ...
                                                ?> 
                                                <h3 class=" text-center alert alert-success"><a href="../"><strong>You may now run the system!</strong></a></h3> 
                                                
                                               <!--  <div class="alert alert-success">
                                                    <strong><a href="localhost/aqualife">Your may now start to Login!</a></strong>
                                                </div> -->
                                                <?php } ?>
...
<footer class="footer text-center">
    <div class="container fText">
        <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
            <div class="row">
                <div class="col-sm-6 text-left">Developed by <a  target="_blank" href="https://pressdy.lovestoblog.com/">Pressdy</a></div>
            </div>
        </div>
    </div>
</footer>
